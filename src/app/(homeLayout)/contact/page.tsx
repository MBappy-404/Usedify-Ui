...
export default function Contact() {
  const socialPlatforms = [
    {
      name: "Facebook",
      icon: <SlSocialFacebook className="w-6 h-6 text-gray-600" />,
    },
    {
      name: "Twitter",
      icon: <SlSocialTwitter className="w-6 h-6 text-gray-600" />,
    },
    {
      name: "Instagram",
      icon: <SlSocialInstagram className="w-6 h-6 text-gray-600" />,
    },
    {
      name: "LinkedIn",
      icon: <SlSocialLinkedin className="w-6 h-6 text-gray-600" />,
    },
  ];
  return (
